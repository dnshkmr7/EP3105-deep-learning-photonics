...
class SpectrumTransformer(nn.Module):
    def __init__(self, input_dim, param_dim, output_dim, nhead, num_encoder_layers, dropout = 0.1):
        ...
        # Embedding layers for input sequence and parameters
        ...
        encoder_layer = nn.TransformerEncoderLayer(d_model = self.embed_dim, nhead = nhead, dropout = dropout, batch_first=True)
